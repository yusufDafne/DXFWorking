...
KARISMAZ (onlar kendi modullerinde/yerlerinde kalir).

NOT (rev-18): DEV-025 kapsaminda burada bir zamanlar `ScaleBar` (grafik
olcek cubugu) sinifi vardi; kullanici geri bildirimiyle ("her pafta
içerisinde ölçek gibi bir şey var ... onu istemiyorum, kaldır")
KALDIRILDI. Kuzey oku (`scripts/northarrow`) etkilenmedi, hala her kat
paftasinda cizilir.
"""
